...
*/
Gallery=function(){function n(n){var r,t,i;for(this.items=[],this._currentIndex=0,r=this,t=0;t<n.length;t++)i=n[t],i.onclick=function(n){r.onItemClicked(this,n);n.preventDefault();n.stopPropagation()},this.items.push(i);this.initMarkup()}return n.prototype.initMarkup=function(){var f=this,a=sel("body"),t=document.createElement("div"),n,e,o,i,h,r,c,u,s,l;t.classList.add("imageViewer");this._main=t;n=document.createElement("div");n.classList.add("imageViewer-wrapper");t.appendChild(n);e=document.createElement("div");e.classList.add("imageViewer-content");o=document.createElement("div");o.classList.add("container");e.appendChild(o);this._content=o;this._content.onclick=function(){return f.close()};n.appendChild(e);this.items.length>1&&(i=document.createElement("span"),i.classList.add("imageViewer-prev"),h=document.createElement("span"),h.innerText="<",i.onclick=function(){return f.prev()},i.appendChild(h),n.appendChild(i),r=document.createElement("span"),c=document.createElement("span"),c.innerText=">",r.onclick=function(){return f.next()},r.appendChild(c),r.classList.add("imageViewer-next"),n.appendChild(r));u=document.createElement("span");u.innerText="X";u.classList.add("imageViewer-close");u.onclick=function(){return f.close()};n.appendChild(u);s=document.createElement("div");s.classList.add("imageViewer-caption");l=document.createElement("span");s.appendChild(l);this._captionContent=l;t.appendChild(s);a.appendChild(t)},n.prototype.onItemClicked=function(n){this._currentItems=this.items.filter(function(t){return t.getAttribute("data-imageViewer")===n.getAttribute("data-imageViewer")});this._currentIndex=this._currentItems.indexOf(n);this.loadContent();this._main.style.display="block"},n.prototype.loadContent=function(){var t=this._currentItems[this._currentIndex],i=t.getAttribute("data-target"),r,n,s,e,u,o,f;if(!i)if(t instanceof HTMLAnchorElement)i=t.href;else if(t instanceof HTMLImageElement)i=t.src;else throw new Error("No data-target");if(r=t.getAttribute("data-type"),r||(r=i[0]==="#"?"ref":i.slice(-4).toLowerCase()===".png"||i.slice(-4).toLowerCase()===".jpg"?"image":""),this._originElement){for(u=0;u<this._content.children[0].children.length;u++)this._originElement.appendChild(this._content.children[0].children[u]);this._originElement=null}if(r==="image")this._content.parentElement.style.backgroundImage="url("+i+")",this._content.innerHTML="";else if(r==="youtube")n=document.createElement("div"),n.classList.add("youtube-player"),n.setAttribute("data-id",i),n.setAttribute("title",t.title),this.updateContainer(n),embedded.embedItem(n,"youtube");else if(r==="vimeo")n=document.createElement("div"),n.classList.add("vimeo-player"),n.setAttribute("data-id",i),n.setAttribute("title",t.title),this.updateContainer(n),embedded.embedItem(n,"vimeo");else if(r==="iframe")n=document.createElement("div"),s=t instanceof HTMLImageElement?t.src:t.getAttribute("data-thumb"),n.classList.add("iframe-player"),n.setAttribute("data-id",i),n.setAttribute("title",t.title),n.setAttribute("data-thumb",s),this.updateContainer(n),embedded.embedItem(n,"iframe");else if(r==="ref"){for(e=document.createElement("div"),i="#"+i.split("#").slice(-1)[0],this._originElement=sel(i),this._originElement||(e.innerHTML="Konnte nicht geladen werden!"),u=0;u<this._originElement.children.length;u++)e.appendChild(this._originElement.children[u]);this.updateContainer(e)}else o=document.createElement("iframe"),o.src=i,this.updateContainer(o);f=t.getAttribute("title");f||(f=t.getAttribute("name"),f||(f=t.getAttribute("alt")));this._captionContent.innerText=f?f:""},n.prototype.updateContainer=function(n){this._content.parentElement.style.backgroundImage="";n instanceof HTMLIFrameElement?this._content.classList.add("full"):this._content.classList.remove("full");var t=this._content.children.item(0);t&&this._content.removeChild(t);this._content.appendChild(n)},n.prototype.next=function(){++this._currentIndex===this._currentItems.length&&(this._currentIndex=0);this.loadContent()},n.prototype.prev=function(){--this._currentIndex<0&&(this._currentIndex=this._currentItems.length-1);this.loadContent()},n.prototype.close=function(){var n,t;if(this._originElement){for(n=0;n<this._content.children[0].children.length;n++)this._originElement.appendChild(this._content.children[0].children[n]);this._originElement=null}t=this._content.children.item(0);t&&this._content.removeChild(t);this._main.style.display="none"},n}(),function(){var i=selAll("[data-imageviewer]"),u,n,r,t;if(i.length>0&&(u=new Gallery(i)),n=selAll(".img-description img"),n.length>0)for(r=function(){var i=n[t];i.complete?i.parentElement.classList.add("loaded"):i.onload=function(){i.parentElement.classList.add("loaded")}},t=0;t<n.length;t++)r()}();